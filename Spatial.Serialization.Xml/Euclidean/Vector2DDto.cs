...
{
    [Serializable]
    public struct Vector2DDto : IXmlSerializable, IEquatable<Vector2DDto>, IFormattable
    {
        /// <summary>
        ...
        public Vector2DDto(double x, double y)
        {
            this.X = x;
            this.Y = y;
        }
        ...
        /// <param name="a">The AngleDto</param>
        public Vector2DDto(double r, AngleDto a)
        ...
        public Vector2DDto(IEnumerable<double> data)
            : this(data.ToArray())
        {
        }

        public Vector2DDto(double[] data)
            : this(data[0], data[1])
        {
            if (data.Length != 2)
            {
        ...
        public static Vector2DDto ReadFrom(XmlReader reader)
        {
            var v = new Vector2DDto();
            v.ReadXml(reader);
            return v;
        }
        ...
        public bool Equals(Vector2DDto other)
        {
        ...
        public bool Equals(Vector2DDto other, double tolerance)
        {
            if (tolerance < 0)
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is Vector2DDto && this.Equals((Vector2DDto)obj);
        }
