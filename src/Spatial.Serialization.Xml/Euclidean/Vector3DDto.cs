...
{
    [Serializable]
    public struct Vector3DDto : IXmlSerializable, IEquatable<Vector3DDto>, IEquatable<UnitVector3DDto>, IFormattable
    {
        /// <summary>
        ...
        public Vector3DDto(double x, double y, double z)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        public Vector3DDto(IEnumerable<double> data)
            : this(data.ToArray())
        {
        }

        public Vector3DDto(double[] data)
        ...
        public static Vector3DDto ReadFrom(XmlReader reader)
        {
            var v = new Vector3DDto();
            v.ReadXml(reader);
            return v;
        }
    }
